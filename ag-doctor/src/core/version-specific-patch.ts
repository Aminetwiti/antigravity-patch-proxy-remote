...
import { getPatchVersionOverride, DEFAULT_PROXY_PORT, DEFAULT_BIND_HOST } from './config';
...
export const PATCH_REGISTRY: PatchDefinition[] = [
  ...
  },
  {
    ...
    patchedUrl: `http://${DEFAULT_BIND_HOST}:${DEFAULT_PROXY_PORT}/v1internal/xxxxxxx`,
