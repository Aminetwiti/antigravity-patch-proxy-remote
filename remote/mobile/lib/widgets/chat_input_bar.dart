...
const List<_SlashCommand> _slashCommands = [
  ...
  _SlashCommand(Icons.travel_explore_rounded, '/browser', 'Pair agent with browser CDP & web navigation'),
  _SlashCommand(Icons.groups_rounded, '/teamwork-preview', 'Multi-agent teamwork orchestration'),
  ...
  _SlashCommand(Icons.bug_report_outlined, '/investigate', 'Systematic debugging with root cause investigation'),
  _SlashCommand(Icons.shield_outlined, '/careful', 'Safety guardrails for destructive commands'),
  _SlashCommand(Icons.checklist_rounded, '/qa', 'Systematic QA test web application'),
